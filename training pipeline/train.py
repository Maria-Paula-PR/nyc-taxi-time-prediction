...
@task(name="select challenger", retries=4, retry_delay_seconds=60)
def select_best_model(experiment_name):
    try:
        ...
        # Crear un cliente de MLflow para manipular el modelo
        client = MlflowClient()

        # Agregar la etiqueta al modelo registrado
